#include <stdio.h> 
unsigned long amount=50000, deposition, withdrawal;
int pin, choice, k; 
char transaction ='y';
void main()
{
...
do
{
	printf("university of enginering and technology mardan\n");
printf("Hello! Welcome to UET ATM Service\n");
...
printf("\n\n Thank you so much for your time to choose  the UET ATM services!");
